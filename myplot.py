...
tex_file.writelines("\\usepackage{pgfplots}\n")
tex_file.writelines("\\pgfplotsset{width=10cm,compat=1.9,every axis/.append style={font=\large,line width=1pt,tick style={line width=0.8pt}}}\n")
...
tex_file.writelines("\\begin{axis}[axis lines = left,xlabel = $x$,ylabel = {$f(x)$},]\n")
tex_file.writelines("\\addplot[domain = -2:2, samples = 100,color = blue,thick]{"+tex_equation+"};\n")
tex_file.writelines("\\end{axis}\n")
